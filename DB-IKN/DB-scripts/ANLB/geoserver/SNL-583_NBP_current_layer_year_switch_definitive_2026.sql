\echo "SNL-583 Switching NBP Current layers Status Definitief to 2026"
...
CREATE OR REPLACE VIEW geoserver.v_imna_nbp_viewer_beheer_gebied_ambitie_current
 ...
 WHERE (subsidie_jaar = 2026 and status = '3') OR (subsidie_jaar = 2026 and status = '2');
...
CREATE OR REPLACE VIEW geoserver.v_imna_nbp_viewer_beheer_gebied_current
 ...
 SELECT imna_nbp_viewer_beheer_gebied.provincie,
        ...
        --imna_nbp_viewer_beheer_gebied.toegestane_beheer_paketten,
        --imna_nbp_viewer_beheer_gebied.niet_subsidiabele_beheer_paketten,
...
\echo "removing v_imna_nbp_viewer_deel_gebied_current and metadata"	
DROP VIEW IF EXISTS geoserver.v_imna_nbp_viewer_deel_gebied_current;

DELETE FROM geoserver.gt_pk_metadata
      WHERE table_schema = 'geoserver'
	    AND table_name = 'v_imna_nbp_viewer_deel_gebied_current';
