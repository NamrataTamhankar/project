\echo "IMNA-17169 Switching NBP Current layers Status Definitief to 2025"
...
CREATE OR REPLACE VIEW geoserver.v_imna_nbp_viewer_beheer_gebied_ambitie_current
 ...
 WHERE (subsidie_jaar = 2025 and status = '3') OR (subsidie_jaar = 2025 and status = '2');
