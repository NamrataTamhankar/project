...
--				  AND table_name='besi_report_request' 
--				  AND column_name='object_ids')
--    THEN
--        EXECUTE '
--				 ALTER TABLE IF EXISTS geoweb.besi_report_request 
--				 ADD COLUMN object_ids bigint[] NULL;
--		';
--		RAISE NOTICE 'Alter geoweb.besi_report_request ADD COLUMN';
--    END IF;
--END;
--$$ LANGUAGE 'plpgsql';
--
...
--                END AS "Overige zoogdieren"
--           FROM geoweb.besi_report_request r
--             JOIN besi.v_gw_besi_star_regelink s ON (s.geo_object_id = ANY (r.object_ids)) AND s.werkzaamheid_id = r.werkzaamheid_id) AS foo
--  GROUP BY request_id;
-- 
