\echo "Starting deployment of ETL schema for IKN automatic deployment"
...
SELECT pg_temp.create_constraint_if_not_exists ('etl','validation_geometry_issues','PK_validation_geometry_issues',
'ALTER TABLE etl.validation_geometry_issues ADD CONSTRAINT PK_validation_geometry_issues
	PRIMARY KEY (etl_id, sequence)
;');
