...
CREATE OR REPLACE VIEW masterdata.all_domains AS
    ...
    SELECT
		...
		valid_from,
		valid_to,
        'dmn_deelgebied' AS dmn
    FROM
        masterdata.dmn_deelgebied    
	UNION
    SELECT
        id,
        code,
    ...
    SELECT
		...
		valid_from,
		valid_to,
        'dmn_natuur_type_klimaat' AS dmn
    FROM
        masterdata.dmn_natuur_type_klimaat    
	UNION
    SELECT
        id,
        code,
	...
	SELECT
		...
		valid_from,
		valid_to,
        'dmn_status_zoek_gebied_klimaat' AS dmn
    FROM
        masterdata.dmn_status_zoek_gebied_klimaat		    
	UNION
    SELECT
        id,
        code,
