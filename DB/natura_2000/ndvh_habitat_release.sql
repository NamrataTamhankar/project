...
/*  Created On : 26-Oct-2021 12:28:37 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
CREATE SCHEMA natura_2000
  AUTHORIZATION anlb;   
...
CREATE SEQUENCE natura_2000.n2000_seq
    INCREMENT 1
    START 1
    MINVALUE 1
...
DROP TABLE IF EXISTS natura_2000.natura_2000 CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_eu_karterings_typen CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_eu_typen CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_eu_typen_variant CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_gebied CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_gebied_voortouwnemer CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_habitat_doelstelling CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_sub_typen CASCADE
;

DROP TABLE IF EXISTS natura_2000.natura_2000_sub_typen_variant CASCADE
;

/* Create Tables */

CREATE TABLE natura_2000.natura_2000
(
...
CREATE TABLE natura_2000.natura_2000_eu_karterings_typen
(
...
CREATE TABLE natura_2000.natura_2000_eu_typen
(
	id bigint NOT NULL   DEFAULT NEXTVAL(('n2000_seq'::text)::regclass),
...
CREATE TABLE natura_2000.natura_2000_eu_typen_variant
(
	natura_2000_eu_typen_id bigint NOT NULL,
...
CREATE TABLE natura_2000.natura_2000_gebied
(
...
CREATE TABLE natura_2000.natura_2000_gebied_voortouwnemer
(
	natura_2000_id bigint NOT NULL,
...
CREATE TABLE natura_2000.natura_2000_habitat_doelstelling
(
	natura_2000_id bigint NOT NULL,
...
CREATE TABLE natura_2000.natura_2000_sub_typen
(
	natura_2000_eu_typen_id bigint NOT NULL,
	volg_nummer integer NOT NULL   DEFAULT NEXTVAL(('n2000_seq'::text)::regclass),
...
CREATE TABLE natura_2000.natura_2000_sub_typen_variant
(
	natura_2000_eu_typen_id bigint NOT NULL,
...
CREATE INDEX IXFK_natura_2000_eu_karterings_typen_dmn_natura_2000_kart_typ ON natura_2000.natura_2000_eu_karterings_typen (natura_2000_karterings_type_id ASC)
;

CREATE INDEX IXFK_natura_2000_eu_karterings_typen_natura_2000_eu_typen ON natura_2000.natura_2000_eu_karterings_typen (natura_2000_eu_typen_id ASC)
;
...
CREATE INDEX IXFK_natura_2000_eu_typen_variant_natura_2000_eu_typen ON natura_2000.natura_2000_eu_typen_variant (natura_2000_eu_typen_id ASC)
;
...
CREATE INDEX IXFK_n2000_gebied_dmn_natura_2000_type ON natura_2000.natura_2000_gebied (bescherming_id ASC)
;

CREATE INDEX IXFK_n2000_gebied_natura_2000 ON natura_2000.natura_2000_gebied (natura_2000_id ASC)
;
...
CREATE INDEX IXFK_n2000_gebied_voortouwnemer ON natura_2000.natura_2000_gebied_voortouwnemer (natura_2000_id ASC)
;

CREATE INDEX IXFK_natura_2000_gebied_voortouwnemer_dmn_bronhouder ON natura_2000.natura_2000_gebied_voortouwnemer (voortouw_nemer_id ASC)
;
...
CREATE INDEX IXFK_natura_2000_habitat_doelstelling_dmn_habitat_type ON natura_2000.natura_2000_habitat_doelstelling (habitat_type_id ASC)
;

CREATE INDEX IXFK_natura_2000_habitat_doelstelling_dmn_natura_2000_bijdrage ON natura_2000.natura_2000_habitat_doelstelling (relatieve_bijdrage_id ASC)
;

CREATE INDEX IXFK_natura_2000_habitat_doelstelling_natura_2000 ON natura_2000.natura_2000_habitat_doelstelling (natura_2000_id ASC)
;
...
CREATE INDEX IXFK_natura_2000_sub_typen_natura_2000_eu_typen ON natura_2000.natura_2000_sub_typen (natura_2000_eu_typen_id ASC)
;
...
CREATE INDEX IXFK_natura_2000_sub_typen_variant_natura_2000_sub_typen ON natura_2000.natura_2000_sub_typen_variant (natura_2000_eu_typen_id ASC,natura_2000_sub_typen_natura_2000_sub_typen ASC)
;
