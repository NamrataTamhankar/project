...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="value[parent::attribute/name='global.templateExcel' and 
		...
		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_VRN_Submission'  
		]">
	...
	<xsl:template match="value[parent::attribute/name='value' and 
		...
		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_VRN_Submission' 
		]">
	...
	<!--This is for to change value of the value of "DB_SERVER_IP" which is in the workspace "IMNa_VRN_Sub_UpdateDatabase" -->
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='DB_SERVER_IP' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_VRN_Sub_UpdateDatabase.fmw'] 
		 and ancestor::*/type='automations' 
		 		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_VRN_Submission' 

		]">
		<xsl:element name="value"><xsl:value-of select="$parameters/parameters/db_server_ip" /></xsl:element>
	</xsl:template>
	
	<!--This is for to change value of the value of "PSQL_PATH" which is in the workspace "IMNa_VRN_Sub_UpdateDatabase" -->
	<xsl:template match="value[parent::attribute/name='value' and 
	...
	<!--This is for to change value of the value of "DATABASE_NAME" which is in the workspace "IMNa_VRN_Sub_UpdateDatabase" -->
	<xsl:template match="value[parent::attribute/name='value' and 
	...
	<!--This is for to change value of the value of "DB_USERNAME" which is in the workspace "IMNa_VRN_Sub_UpdateDatabase" -->
	<xsl:template match="value[parent::attribute/name='value' and 
	...
	<xsl:template match="value[parent::attribute/name='value' and 
		...
		<!--This is for to change value of the value of "GeoWeb_Archive" which is in the workspace "IMNa_VRN_Sub_Messenger" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='GeoWeb_Archive' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_VRN_Sub_Messenger.fmw'] and
		ancestor::*/type='automations' 
				and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_VRN_Submission' 
	...
	<!--This is for to change value of the value of "ADMIN_EMAIL" which is in the workspace "IMNa_VRN_Sub_Messenger" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='ADMIN_EMAIL' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_VRN_Sub_Messenger.fmw'] and
		ancestor::*/type='automations' 
	...
	<!--This is for to change value of the value of "SMTP_HOST" which is in the workspace "IMNa_VRN_Sub_Messenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='SMTP_HOST' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_VRN_Sub_Messenger.fmw'] 
		 and ancestor::*/type='automations' 
		 		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_VRN_Submission' 
	...
	<!--This is for to change value of the value of "DropTmpFolder" which is in the workspace "IMNa_VRN_Sub_Messenger" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
