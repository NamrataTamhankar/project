...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="value[parent::attribute/name='value' and 
		...
		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_IKN_End_Koppelvlak' 
		]">
		<xsl:element name="value"><xsl:value-of select="$parameters/parameters/dirwatch_path" /></xsl:element>
	</xsl:template>
	
	<!--This is for to change value of the value of "trigger_folder" which is in the workspace "IMNa_IKN_Koppelvlak_Beeindigen_Trigger" -->		
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='trigger_folder' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_IKN_Koppelvlak_Beeindigen_Trigger.fmw'] and
	...
	<!--This is for to change value of the value of "SMTP_HOST" which is in the workspace "IMNa_IKN_Koppelvlak_Beeindigen_Messenger" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='SMTP_HOST' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_IKN_Koppelvlak_Beeindigen_Messenger.fmw'] and
		ancestor::*/type='automations' 
				and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_IKN_End_Koppelvlak' 
	...
	<!--This is for to change value of the value of "ADMIN_EMAIL" which is in the workspace "IMNa_IKN_Koppelvlak_Beeindigen_Messenger" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
	...
	<!--This is for to change value of the value of "ENVIRONMENT_NAME" which is in the workspace "IMNa_IKN_Koppelvlak_Beeindigen_Messenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='ENVIRONMENT_NAME' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_IKN_Koppelvlak_Beeindigen_Messenger.fmw'] 
	...
	<!--This is for to change value of the value of "DropTmpFolder" which is in the workspace "IMNa_IKN_Koppelvlak_Beeindigen_Messenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
