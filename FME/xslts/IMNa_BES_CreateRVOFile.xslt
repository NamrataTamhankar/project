...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="value[parent::attribute/name='global.templateRVO' and 
		...
		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_BES_CreateRVOFile'  
		]">
	...
	<xsl:template match="value[parent::attribute/name='value' and 
		...
		and parent::attribute/parent::attributes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/parent::items/parent::itemtype/parent::itemtypes/parent::item/attributes/attribute/value='IMNa_BES_CreateRVOFile' 
		]">
		<xsl:element name="value"><xsl:value-of select="$parameters/parameters/dirwatch_path" /></xsl:element>
	</xsl:template>
	
	<!--This is for to change value of the value of "RVO_OUTPUT" which is in the workspace "IMNa_BES_CreateRVOFile" -->	
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='RVO_OUTPUT' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_BES_CreateRVOFile.fmw'] and
	...
	<!--This is for to change value of the value of "ADMIN_EMAIL" which is in the workspace "IMNa_BES_RVOMessenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
		parent::attribute/parent::attributes/parent::item/name='ADMIN_EMAIL' and
		parent::attribute/parent::attributes/parent::item/parent::items/descendant::item[name='WORKSPACE' and descendant::attributes/attribute/value = 'IMNa_BES_RVOMessenger.fmw'] 
	...
	<!--This is for to change value of the value of "SMTP_HOST" which is in the workspace "IMNa_BES_RVOMessenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
		...
		<!--This is for to change value of the value of "DropTmpFolder" which is in the workspace "IMNa_BES_RVOMessenger" -->
	<xsl:template match="value[parent::attribute/name='value' and 
