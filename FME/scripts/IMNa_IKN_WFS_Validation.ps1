...
$PARAMETER_FILE = $Properties.'PARAMETER_FILE_IMNa_IKN_WFS_Validation'
$AUTOMATION_NAME = 'IMNa_IKN_WFS_Validation'
...
# Unzip project file
	...
	# Call Remove_Project_Dependencies.ps1 with the arguments to remove files directory, clear content in files.map and Update project yaml file
	#D:\GitLab-Deployments\IMNa\FME\scripts\Remove_Project_Dependencies.ps1 -PROJECT_FILE $PROJECT_FILE -AUTOMATION_NAME $AUTOMATION_NAME
...
# Publish workspaces to FME Server	
	...
	$excludeWorkspaces = @('IMNa_IKN_ConvertFGDBFile.fmw', 'IMNa_IKN_FGDB_SubmissionInitializer.fmw', 'IMNa_IKN_FDGB_SpecificRepairs.fmw', 'IMNa_IKN_FDGB_SchemaTransformer.fmw', 'IMNa_IKN_FGDB_ValidationInitializer.fmw','IMNa_IKN_CreateProvince BorderFromWFS.fmw', 'IMNa_IKN_SchemaTransformer.fmw' )
	try{
