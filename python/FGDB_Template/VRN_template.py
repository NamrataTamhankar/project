...
fgdb_out_name = "VRN_template.gdb"
out_version = "10.0"
...
with arcpy.da.InsertCursor(TBL_path, ["versie", "datumCreatie", "releaseNotes"]) as cursor:
    ...
    cursor.insertRow(["5", "03/03/2021", "IMNA-2437 - VRN Province border file"])
    cursor.insertRow(["6", "11/03/2021", "IMNA-2431 - VRN Attribute statusVerwerving in kaartlaag GebiedVerwerving has to be removed"])
    cursor.insertRow(["7", "15/03/2021", "IMNA-2922 - Add default value to rapportageJaar and IMNA-2439 - Remove attributes resterendeInrichtingNatuurpact and resterendeInrichtingAanvullend and add attribute resterendeInrichtingsAmbitie in kaartlaag ResterendeInrichtingsambitie"])
    cursor.insertRow(["2022.1.1", "15/03/2022", "IMNA-5792 - Template for year 2021"])
    ...
    cursor.insertRow(["2025.1.1", "30/01/2025", "IMNA-18120 VRN: Generate new year (2024)"])
...
arcpy.AssignDefaultToField_management(TB_path, "rapportageJaar", 2025)
...
arcpy.SortCodedValueDomain_management(input_gdb, "domStatusNatuur", "CODE", "ASCENDING")
