...
fgdb_out_name = "NBP_RVO_template.gdb"
out_version = "10.0"
...
with arcpy.da.InsertCursor(TBL_path, ["versie", "datumCreatie", "releaseNotes"]) as cursor:
    cursor.insertRow(["2021.1.1", "15/03/2021", "FGDB Template for RVO and BoerEnnNatuur"])
    cursor.insertRow(["2022.1.1", "11/02/2022", "IMNA-6112 - Updating for NBP Changes 2023"])
    cursor.insertRow(["2022.1.2", "18/02/2022", "IMNA-5960 - New provincie borders"])
    cursor.insertRow(["2022.1.3", "09/03/2022", "IMNA-6403 - Updated beheertype domain"])
    cursor.insertRow(["2022.1.4", "24/03/2022", "IMNA-6600 - Updated deelgebied domain"])
    cursor.insertRow(["2022.1.5", "01/04/2022", "IMNA-6638, IMNA-6670 - Updated deelgebied domain and status"])
    cursor.insertRow(["2022.1.6", "01/07/2022", "IMNA-6795 - Updated deelgebied domain and status"])
    cursor.insertRow(["2022.1.7", "08/08/2022", "M2208-014 - Updated deelgebied domain"])
