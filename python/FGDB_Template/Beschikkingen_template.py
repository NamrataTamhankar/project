...
fgdb_out_name = "Beschikkingen_template.gdb"
out_version = "10.0"
...
with arcpy.da.InsertCursor(TBL_path, ["versie", "datumCreatie", "releaseNotes"]) as cursor:
    cursor.insertRow(["v2020.2", "25/05/2020", "Template voor het indienen van Beschikkingen voor beheerjaar 2020"])
    cursor.insertRow(["v2021.1", "06/04/2021", "Template voor het indienen van Beschikkingen voor beheerjaar 2021"])
    cursor.insertRow(["v2022.1", "10/02/2022", "Template for 2022 and IMNA-5586: Modified regelingen domain"])
    cursor.insertRow(["v2022.2", "11/02/2022", "IMNA-5586: Modified provincie domain"])
    cursor.insertRow(["v2022.3", "18/02/2022", "IMNA-5960: New provincie borders"])
    ...
    cursor.insertRow(["v2024.2", "06/02/2024", "IMNA-12543: BES: Generate new year (2024)"])
    cursor.insertRow(["v2024.3", "19/02/2024", "IMNA-13252: SNL: update 'Bestuurlijke gebieden' as per  2024"])
    cursor.insertRow(["v2025.1", "30/01/2025", "IMNA-18107 BES: Generate new year (2025)"])
    cursor.insertRow(["v2025.2", "31/01/2025", "IMNA-18126 SNL: Annual update Bestuurlijke gebieden"])
...
arcpy.AssignDefaultToField_management(TB_path, "beheerJaar", 2026)
